...
router.get('/combos/edit/:id',     adminController.getEditCombo);
router.post('/combos/edit/:id',    upload.single('image'), adminController.postEditCombo);
router.post('/combos/toggle/:id',  adminController.toggleCombo);
router.get('/combos/delete/:id',   adminController.deleteCombo);

// Orders
router.get('/orders',              orderController.getAllOrders);
router.get('/orders/:id/invoice',  orderController.printInvoice);
